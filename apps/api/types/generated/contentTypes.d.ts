...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventend: Schema.Attribute.Date;
    eventstart: Schema.Attribute.Date;
    eventtype: Schema.Attribute.Relation<
      'oneToOne',
      'api::eventtype.eventtype'
    >;
    headingImage: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::event.event'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.Component<'shared.address', false>;
    publishedAt: Schema.Attribute.DateTime;
    registrationUntilDate: Schema.Attribute.Date;
...
export interface ApiEventtypeEventtype extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    descriptionLongHTML: Schema.Attribute.Blocks & Schema.Attribute.Required;
    gyakori_kerdeseks: Schema.Attribute.Relation<
      'oneToMany',
      'api::gyakori-kerdes.gyakori-kerdes'
    >;
    headingImage: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::eventtype.eventtype'
...
export interface ApiGyakoriKerdesGyakoriKerdes
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    kerdes: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 3;
      }>;
    ...
    > &
      Schema.Attribute.Private;
    program: Schema.Attribute.Relation<'manyToOne', 'api::eventtype.eventtype'>;
    publishedAt: Schema.Attribute.DateTime;
    rank: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    valasz: Schema.Attribute.Blocks & Schema.Attribute.Required;
  };
}
...
export interface ApiHasznosCimekOldalHasznosCimekOldal
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tartalom: Schema.Attribute.Blocks & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiKapcsolatOldalKapcsolatOldal
  extends Struct.SingleTypeSchema {
...
export interface ApiQuoteQuote extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    forras: Schema.Attribute.String & Schema.Attribute.Required;
    idezet: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 255;
      }>;
...
export interface ApiSettingSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    karbantartas: Schema.Attribute.Component<
...
export interface ApiTanitasTanitas extends Struct.CollectionTypeSchema {
...
export interface ApiTanusagtetelTanusagtetel
  extends Struct.CollectionTypeSchema {
